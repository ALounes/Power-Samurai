...
#define ALAN_TURING_RANGE2 -1
#define ALAN_TURING_RANGE3 -1
#define ALAN_TURING_DELAY1 5
#define ALAN_TURING_DELAY2 7
#define ALAN_TURING_DELAY3 10
#define ALAN_TURING_DMG1 500
#define ALAN_TURING_DMG2 100
#define ALAN_TURING_DMG3 200
