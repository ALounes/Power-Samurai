...
#define ALAN_TURING_DELAY1 0.5
#define ALAN_TURING_DELAY2 4
#define ALAN_TURING_DELAY3 20
#define ALAN_TURING_DMG1 250
#define ALAN_TURING_DMG2 450
#define ALAN_TURING_DMG3 1000
#define ALAN_TURING_V2I1 Vector2i(5,3)
#define ALAN_TURING_V2I2 Vector2i(5,6)
#define ALAN_TURING_V2I3 Vector2i(5,4)
...
class AlanTuring : public Player
{
	...
	AlanTuring(RenderWindow *win, Image &image, Map *myMap, Image* image1, Image* image2, Image* image3);
	~AlanTuring();
