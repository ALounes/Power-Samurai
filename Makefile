...
BIN = PowerSamurai
OBJ = main.o projectile.o difficultyMenu.o mainMenu.o map.o splashScreen.o game.o playersMenu.o main.o animation.o entity.o player.o bot.o linustorvalds.o alanturing.o bjarnestroustrup.o camera.o map.o node_bot.o item.o statusbar.o livingentity.o animationeffect.o folowinganimation.o staticanimation.o greendragon.o troll.o armor1.o reaper1.o
